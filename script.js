const translations = {
  es: {
    ...
    productPrivateTitle: "Sistemas privados de producción y perfil",
    productPrivateBody: "Sistemas privados LaTeX Documents y Quarto Slides para manuscritos y presentaciones científicas, más un sistema interno de sincronización de CV/perfil que mantiene alineados CVN, CV, ORCID, GitHub, la web, LinkedIn, ResearchGate y Google Scholar.",
