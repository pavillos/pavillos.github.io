const translations = {
  es: {
    ...
    career1Title: "Postdoctoral Research Assistant · CNIO/CIBERONC",
    career1Body: "IA, investigación en cáncer, microbioma, transcriptómica espacial y productos de datos traslacionales.",
    career2Title: "Investigador predoctoral · CIBIR / Universidad de La Rioja",
    career2Body: "Análisis de microbioma y viroma en infección por VIH, inflamación y riesgo cardiovascular, incluyendo estancias en KU Leuven.",
    educationTitle: "Formación",
    educationDegrees: "Doctorado, Bioinformática, Bioestadística, IA, Biotecnología y Bioquímica",
    educationBody: "Doctorado con Cum Laude, Mención Internacional y Premio Extraordinario de Doctorado; formación de posgrado en Bioinformática, Bioestadística e IA.",
